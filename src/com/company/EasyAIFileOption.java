...
public class EasyAIFileOption extends EasyAI {


    @SuppressWarnings("Duplicates")
    public HashMap<Integer, ArrayList<String>> easyAiGameFileOption(String computerCode) {
        ...
        while (guessCount > 0) {
            ...
            // user turn with results and win option while using file guesses
            if (turnsToUseFromFile.size() > 0) {
                ...
                //once file runs out back to normal
            } else {
